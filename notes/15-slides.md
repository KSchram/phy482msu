...
Note:
* Correct Answer: C
* Jx is easy to see, and there's no E out there
</section>
...
Note:
* Correct Answer: B
* There's no J there, Ex points to the right and is increasing
</section>
...
**At location 5**, what are the signs of $J_x$, $dE_x/dt$, and $(\nabla \times \mathbf{B})_x$?
